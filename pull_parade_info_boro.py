...
#Type/Weekday-Hour aggregation
    def get_wkday_hour(rows):
        ...
        st_patricks = [(3, 17, 2006), (3, 17, 2007), (3, 17, 2008), (3, 17, 2009), (3, 17, 2010), (3, 17, 2011), (3, 17, 2012), (3, 17, 2013), (3, 17, 2014), (3, 17, 2015)]
        veterans = [(11, 11, 2006), (11, 11, 2007), (11, 11, 2008), (11, 11, 2009), (11, 11, 2010), (11, 11, 2011), (11, 11, 2012), (11, 11, 2013), (11, 11, 2014), (11, 11, 2015)]
        NYC_parades_all = NYC_Marathon_list + NYC_Half_Marathon_list + st_patricks + veterans
        NYC_parades_dts = [datetime.datetime(x[2],x[0],x[1]) for x in NYC_parades_all]
        
        try:
            month, day, year = (int(x) for x in rows[1].split('/'))
            dt = datetime.datetime(year, month, day)
            lwk = dt - timedelta(days=7)
            if dt in NYC_parades_dts:
                test_group = 1
            elif lwk in NYC_parades_dts:
                test_group = 0
            else:
    ...
    by_type_wkday_hr.saveAsTextFile('parade_info_boro.out')
    sc.stop()
